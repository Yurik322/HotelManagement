//-----------------------------------------------------------------------
// <copyright file="AccountController.cs" company="My">
...
namespace HotelManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(HotelManagementUserManager userManager, HotelManagementSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new HotelManagementUser { UserName = model.Email, Email = model.Email };
